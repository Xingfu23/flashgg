...
htl_paths = []
if customize.campaign == 'Era2016_RR-17Jul2018_v2':
	hlt_paths = ["HLT_Diphoton30_18_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90*"]
elif customize.campaign == 'Era2017_RR-31Mar2018_v2':
	hlt_paths = ["HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90*", "HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass95*"]
elif customize.campaign == 'Era2017_legacy_v1':
	hlt_paths = ["HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90*", "HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass95*"]
elif customize.campaign == 'Era2018_RR-17Sep2018_v2':
	hlt_paths = ["HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90*", "HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass95*"]
