...
class MuonSF_JSONReader :
    def __init__(self , file_name , sf_name , lowPt_file_name="" , lowPt_sf_name="", extendPt=0 ):
        ...
        # if lowPt_file_name!="" and lowPt_sf_name!="NUM_HighPtID_DEN_genTracks" and lowPt_sf_name!="NUM_MediumPromptID_DEN_genTracks" and lowPt_sf_name!="NUM_TrkHighPtID_DEN_genTracks" : # Uncomment this line if use ReReco dataset
