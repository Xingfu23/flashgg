...
flashggVHMetTag = cms.EDProducer("FlashggVHMetTagProducer",
                                    ...
                                    vhmetanom_fa3zh_bdt_xmlfile = cms.FileInPath('/eos/cms/store/group/phys_higgs/cmshgg/flashgg-data/Taggers/data/VH_Anomalous/VHMet/VHMET_ZHiggs0MToGG_M125_model.xml')
)
