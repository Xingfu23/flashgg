...
VHMET_BDT_Helper::VHMET_BDT_Helper(const string& mva_algo, const std::string& weight_file_name)
{
  ...
  // reader_->AddVariable("pho1_R9"          , &varList_.pho1_R9          );
  // reader_->AddVariable("pho2_R9"          , &varList_.pho2_R9          );
  // reader_->AddVariable("pho1_sieie"       , &varList_.pho1_sieie       );
  // reader_->AddVariable("pho2_sieie"       , &varList_.pho2_sieie       );
  ...
  // reader_->AddVariable("dphi_dipho_met"   , &varList_.dphi_dipho_met   );
...
void VHMET_BDT_Helper::print_details(InputVariables var)
{
    ...
    // printf("%s: %.10f , " , "pho1_R9"          , var.pho1_R9          );
    // printf("%s: %.10f , " , "pho2_R9"          , var.pho2_R9          );    
    // printf("%s: %.10f , " , "pho1_sieie"       , var.pho1_sieie       );
    // printf("%s: %.10f , " , "pho2_sieie"       , var.pho2_sieie       );    
    ...
    // printf("%s: %.10f , " , "dphi_dipho_met"   , var.dphi_dipho_met   );
...
void VHMET_BDT_Helper::print_details_cout(InputVariables var)
{
    ...
    // std::cout << "pho1_R9: "          << var.pho1_R9          << ", ";
    // std::cout << "pho2_R9: "          << var.pho2_R9          << ", ";
    // std::cout << "pho1_sieie: "       << var.pho1_sieie       << ", ";
    // std::cout << "pho2_sieie: "       << var.pho2_sieie       << ", ";
    ...
    // std::cout << "dphi_dipho_met: "   << var.dphi_dipho_met   << ", ";
