...
from flashgg.Taggers.VHLeptonicTagsVariables_cfi import dipho_variables, jet_variables, met_variables, gen_variables
import os
import copy
...
if is_signal:
    ...
    if customize.doHTXS:
        ...
        if customize.dumpWorkspace:
            ...
            variablesToUse = minimalVariables + dipho_variables + jet_variables + met_variables + gen_variables
